    ...
    <div className="fixed inset-0 z-[200] flex items-center justify-center bg-[#fdfcf8] dark:bg-zinc-950 transition-colors">
      ...
      >
        <div className="flex flex-col items-center text-center">
          ...
          <div className="mt-10 w-full rounded-[2.5rem] border border-zinc-100 dark:border-zinc-800 bg-white dark:bg-zinc-900 p-8 shadow-2xl overflow-hidden relative">
